...
if {[file isfile accelerator.autotvin.dat]} {
	file delete -force accelerator.autotvin.dat
}

if {[file isfile accelerator.autotvout.dat]} {
	file delete -force accelerator.autotvout.dat
}
