...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pulse_gen.autotvin.dat"
	set constFileTvOut       "pulse_gen.autotvout.dat"
	set constFileHdlTvIn     "pulse_gen.autohdltvin.dat"
	set constFileHdlTvOut    "pulse_gen.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
