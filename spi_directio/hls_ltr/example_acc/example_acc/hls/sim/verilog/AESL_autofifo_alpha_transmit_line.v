...
module AESL_autofifo_alpha_transmit_line (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.example_acc.autotvin_alpha_transmit_line.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.example_acc.autotvout_alpha_transmit_line.dat";
