namespace eval ::optrace {
  variable script "C:/GIM/hls_ltr/project_1/project_1.runs/impl_1/design_1_wrapper.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/GIM/hls_ltr/project_1/project_1.cache/wt [current_project]
