...
HD_PWD='C:/Users/Dawso/GIM-2024-2025/spi_directio/hls_daw/demo_last/demo_last.runs/design_1_example_acc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_example_acc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_example_acc_0_0.tcl
