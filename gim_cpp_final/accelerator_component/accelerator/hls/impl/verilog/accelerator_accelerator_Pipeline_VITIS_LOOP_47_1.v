...
module accelerator_accelerator_Pipeline_VITIS_LOOP_47_1 (
        ...
        w1_local_out,
        w1_local_out_ap_vld,
        bias_2_local_idx4_promoted151_out,
        bias_2_local_idx4_promoted151_out_ap_vld,
        bias_2_local_idx_promoted149_out,
        bias_2_local_idx_promoted149_out_ap_vld,
        bias_1_local_idx1_promoted147_out,
        bias_1_local_idx1_promoted147_out_ap_vld,
        bias_1_local_idx_promoted145_out,
        bias_1_local_idx_promoted145_out_ap_vld
);
...
output  [15:0] bias_2_local_idx4_promoted151_out;
output   bias_2_local_idx4_promoted151_out_ap_vld;
output  [15:0] bias_2_local_idx_promoted149_out;
output   bias_2_local_idx_promoted149_out_ap_vld;
output  [15:0] bias_1_local_idx1_promoted147_out;
output   bias_1_local_idx1_promoted147_out_ap_vld;
output  [15:0] bias_1_local_idx_promoted145_out;
output   bias_1_local_idx_promoted145_out_ap_vld;
...
reg bias_2_local_idx4_promoted151_out_ap_vld;
reg bias_2_local_idx_promoted149_out_ap_vld;
reg bias_1_local_idx1_promoted147_out_ap_vld;
reg bias_1_local_idx_promoted145_out_ap_vld;
...
reg   [15:0] bias_1_local_idx_promoted145_fu_74;
wire   [15:0] select_ln48_8_fu_501_p3;
reg   [15:0] bias_1_local_idx1_promoted147_fu_78;
wire   [15:0] select_ln48_9_fu_508_p3;
reg   [15:0] bias_2_local_idx_promoted149_fu_82;
wire   [15:0] select_ln48_11_fu_522_p3;
reg   [15:0] bias_2_local_idx4_promoted151_fu_86;
wire   [15:0] select_ln48_10_fu_515_p3;
reg   [15:0] w1_local_fu_90;
wire   [15:0] select_ln48_7_fu_494_p3;
reg   [15:0] w1_local_1_fu_94;
wire   [15:0] select_ln48_6_fu_487_p3;
reg   [15:0] w2_local_fu_98;
wire   [15:0] select_ln48_5_fu_480_p3;
reg   [15:0] w2_local_1_fu_102;
...
#0 n_fu_70 = 2'd0;
#0 bias_1_local_idx_promoted145_fu_74 = 16'd0;
#0 bias_1_local_idx1_promoted147_fu_78 = 16'd0;
#0 bias_2_local_idx_promoted149_fu_82 = 16'd0;
#0 bias_2_local_idx4_promoted151_fu_86 = 16'd0;
#0 w1_local_fu_90 = 16'd0;
#0 w1_local_1_fu_94 = 16'd0;
#0 w2_local_fu_98 = 16'd0;
#0 w2_local_1_fu_102 = 16'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            bias_1_local_idx1_promoted147_fu_78 <= 16'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            bias_1_local_idx_promoted145_fu_74 <= 16'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            bias_2_local_idx4_promoted151_fu_86 <= 16'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            bias_2_local_idx_promoted149_fu_82 <= 16'd0;
        end else if ((ap_enable_reg_pp0_iter1 == 1'b1)) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln47_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        bias_1_local_idx1_promoted147_out_ap_vld = 1'b1;
    end else begin
        bias_1_local_idx1_promoted147_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln47_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        bias_1_local_idx_promoted145_out_ap_vld = 1'b1;
    end else begin
        bias_1_local_idx_promoted145_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln47_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        bias_2_local_idx4_promoted151_out_ap_vld = 1'b1;
    end else begin
        bias_2_local_idx4_promoted151_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln47_fu_350_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        bias_2_local_idx_promoted149_out_ap_vld = 1'b1;
    end else begin
        bias_2_local_idx_promoted149_out_ap_vld = 1'b0;
    end
end
...
assign bias_1_local_idx1_promoted147_out = bias_1_local_idx1_promoted147_fu_78;

assign bias_1_local_idx_promoted145_out = bias_1_local_idx_promoted145_fu_74;

assign bias_2_address0 = zext_ln47_fu_366_p1;

assign bias_2_ce0 = bias_2_ce0_local;

assign bias_2_local_idx4_promoted151_out = bias_2_local_idx4_promoted151_fu_86;

assign bias_2_local_idx_promoted149_out = bias_2_local_idx_promoted149_fu_82;
...
assign select_ln48_10_fu_515_p3 = ((icmp_ln48_reg_768[0:0] == 1'b1) ? bias_2_local_idx4_promoted151_fu_86 : bias_2_q0);

assign select_ln48_11_fu_522_p3 = ((icmp_ln48_reg_768[0:0] == 1'b1) ? bias_2_q0 : bias_2_local_idx_promoted149_fu_82);
...
assign select_ln48_4_fu_473_p3 = ((icmp_ln48_reg_768[0:0] == 1'b1) ? w2_local_1_fu_102 : w2_q0);

assign select_ln48_5_fu_480_p3 = ((icmp_ln48_reg_768[0:0] == 1'b1) ? w2_local_fu_98 : w2_q1);

assign select_ln48_6_fu_487_p3 = ((icmp_ln48_reg_768[0:0] == 1'b1) ? w1_local_1_fu_94 : w1_q0);

assign select_ln48_7_fu_494_p3 = ((icmp_ln48_reg_768[0:0] == 1'b1) ? w1_local_fu_90 : w1_q1);

assign select_ln48_8_fu_501_p3 = ((icmp_ln48_reg_768[0:0] == 1'b1) ? bias_1_q0 : bias_1_local_idx_promoted145_fu_74);

assign select_ln48_9_fu_508_p3 = ((icmp_ln48_reg_768[0:0] == 1'b1) ? bias_1_local_idx1_promoted147_fu_78 : bias_1_q0);
