...
HLS_SOURCES = ../../../../main.cpp ../../../../accelerator.cpp ../../../../act_pe.cpp ../../../../array.cpp ../../../../bias_pe.cpp ../../../../error_pe.cpp ../../../../weight_pe.cpp
...
$(ObjDir)/main.o: ../../../../main.cpp $(ObjDir)/.dir
	...
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -DHWCOSIM -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \
