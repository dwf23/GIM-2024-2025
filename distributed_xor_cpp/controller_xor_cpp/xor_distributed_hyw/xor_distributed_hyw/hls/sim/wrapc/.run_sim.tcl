...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "accelerator_controller.autotvin.dat"
	set constFileTvOut       "accelerator_controller.autotvout.dat"
	set constFileHdlTvIn     "accelerator_controller.autohdltvin.dat"
	set constFileHdlTvOut    "accelerator_controller.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
