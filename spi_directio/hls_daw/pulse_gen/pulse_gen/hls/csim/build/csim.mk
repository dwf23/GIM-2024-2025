...
HLS_SOURCES = ../../../../../pulse_gen_tb.cpp ../../../../../pulse_gen.cpp
...
$(ObjDir)/pulse_gen_tb.o: ../../../../../pulse_gen_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../pulse_gen_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -DHW_COSIM -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/pulse_gen_tb.d

$(ObjDir)/pulse_gen.o: ../../../../../pulse_gen.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../pulse_gen.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/pulse_gen.d
