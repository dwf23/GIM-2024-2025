...
// wrapc file define:
#define AUTOTB_TVIN_data_out "../tv/cdatafile/c.spi_master_logic.autotvin_data_out.dat"
...
#define AUTOTB_TVOUT_data_in "../tv/cdatafile/c.spi_master_logic.autotvout_data_in.dat"
#define WRAPC_DIRECTIO_SIZE_IN_data_in "../tv/directio_size/directio_size_in_data_in.dat"
#define WRAPC_DIRECTIO_INGRESS_STATUS_data_in "../tv/directio_size/directio_ingress_status_data_in.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_data_out "../tv/rtldatafile/rtl.spi_master_logic.autotvout_data_out.dat"
...
extern "C"
void spi_master_logic_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_spi_master_logic_hw(void* __xlx_apatb_param_data_out, void* __xlx_apatb_param_data_in)
{
  static hls::sim::DirectIO<hls::sim::Byte<4>> port0 {
    .width = 32,
    .name = "data_out",
#ifdef POST_CHECK
  ...
  port0.param = (hls::directio<hls::sim::Byte<4>>*)__xlx_apatb_param_data_out;
  port0.hasWrite = true;

  static hls::sim::DirectIO<hls::sim::Byte<4>> port1 {
    .width = 32,
    .name = "data_in",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_DIRECTIO_SIZE_IN_data_in),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_data_in),
    .swriter = new hls::sim::Writer(WRAPC_DIRECTIO_SIZE_IN_data_in),
    .gwriter = new hls::sim::Writer(WRAPC_DIRECTIO_INGRESS_STATUS_data_in),
#endif
  };
  port1.param = (hls::directio<hls::sim::Byte<4>>*)__xlx_apatb_param_data_in;
  ...
  try {
    ...
    spi_master_logic_hw_stub_wrapper(__xlx_apatb_param_data_out, __xlx_apatb_param_data_in);
    port0.buffer();
