...
Inference acc_beta(fixed_16 w2[ARRAY_SIZE][ARRAY_SIZE],
    ...
    for (i = 0; i < NUM_ITERATIONS; i++) {
        ...
        for (j = 0; j < 4; j++) {
            ...
            while(expecting_input){
                std::cout << "waiting for input 1" << std::endl;
                ...
                if (read_output_1_packet.dest == 1){
                    ...
                    std::cout << "Got data with dest " << read_output_1_packet.dest << std::endl;
                }
