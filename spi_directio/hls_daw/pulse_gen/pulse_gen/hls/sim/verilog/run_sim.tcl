...
if {[file isfile pulse_gen.autotvin.dat]} {
	file delete -force pulse_gen.autotvin.dat
}

if {[file isfile pulse_gen.autotvout.dat]} {
	file delete -force pulse_gen.autotvout.dat
}
