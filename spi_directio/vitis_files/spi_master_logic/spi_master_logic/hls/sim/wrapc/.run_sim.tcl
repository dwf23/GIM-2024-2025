...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "spi_master_logic.autotvin.dat"
	set constFileTvOut       "spi_master_logic.autotvout.dat"
	set constFileHdlTvIn     "spi_master_logic.autohdltvin.dat"
	set constFileHdlTvOut    "spi_master_logic.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
