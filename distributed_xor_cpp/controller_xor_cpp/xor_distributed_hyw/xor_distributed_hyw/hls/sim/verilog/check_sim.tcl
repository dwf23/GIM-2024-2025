...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.accelerator_controller.autotvin_w1.dat"
         "c.accelerator_controller.autotvin_bias_1.dat"
         "c.accelerator_controller.autotvin_training.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.accelerator_controller.autotvout_data_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
