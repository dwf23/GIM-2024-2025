...
int main() {
    ...
    // Wait for the transfer to complete (this is just an example, you may need a more sophisticated mechanism)
    ...
    // Join the thread (in a real application, you would have a proper mechanism to stop the thread)
