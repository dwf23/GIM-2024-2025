...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "spi_master.autotvin.dat"
	set constFileTvOut       "spi_master.autotvout.dat"
	set constFileHdlTvIn     "spi_master.autohdltvin.dat"
	set constFileHdlTvOut    "spi_master.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
