...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "example_acc.autotvin.dat"
	set constFileTvOut       "example_acc.autotvout.dat"
	set constFileHdlTvIn     "example_acc.autohdltvin.dat"
	set constFileHdlTvOut    "example_acc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
