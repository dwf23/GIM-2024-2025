...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (alpha_transmit_line_0,
    alpha_transmit_line_ap_ack_0,
    alpha_transmit_line_ap_vld_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.ALPHA_TRANSMIT_LINE_0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.ALPHA_TRANSMIT_LINE_0, LAYERED_METADATA undef" *) output [0:0]alpha_transmit_line_0;
  ...
  design_1_example_acc_0_0 example_acc_0
       (.alpha_transmit_line(alpha_transmit_line_0),
        .alpha_transmit_line_ap_ack(alpha_transmit_line_ap_ack_0),
        .alpha_transmit_line_ap_vld(alpha_transmit_line_ap_vld_0),
