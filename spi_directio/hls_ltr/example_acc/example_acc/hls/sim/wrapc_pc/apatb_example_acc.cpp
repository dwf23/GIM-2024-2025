...
#define AUTOTB_TVIN_alpha_transmit_line "../tv/cdatafile/c.example_acc.autotvin_alpha_transmit_line.dat"
#define AUTOTB_TVOUT_alpha_transmit_line "../tv/cdatafile/c.example_acc.autotvout_alpha_transmit_line.dat"
#define WRAPC_DIRECTIO_SIZE_OUT_alpha_transmit_line "../tv/directio_size/directio_size_out_alpha_transmit_line.dat"
#define WRAPC_DIRECTIO_EGRESS_STATUS_alpha_transmit_line "../tv/directio_size/directio_egress_status_alpha_transmit_line.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_alpha_transmit_line "../tv/rtldatafile/rtl.example_acc.autotvout_alpha_transmit_line.dat"
...
extern "C"
void example_acc_hw_stub_wrapper(hls::sim::Byte<2>*, hls::sim::Byte<2>*, void*);

extern "C"
void apatb_example_acc_hw(hls::sim::Byte<2>* __xlx_apatb_param_w1, hls::sim::Byte<2>* __xlx_apatb_param_w2, void* __xlx_apatb_param_alpha_transmit_line)
{
  ...
  port0.param = __xlx_apatb_param_w1;
  ...
  port1.param = __xlx_apatb_param_w2;

  static hls::sim::DirectIO<hls::sim::Byte<1>> port2 {
    .width = 1,
    .name = "alpha_transmit_line",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_alpha_transmit_line),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_alpha_transmit_line),
    .swriter = new hls::sim::Writer(WRAPC_DIRECTIO_SIZE_OUT_alpha_transmit_line),
    .gwriter = new hls::sim::Writer(WRAPC_DIRECTIO_EGRESS_STATUS_alpha_transmit_line),
#endif
  };
  port2.param = (hls::directio<hls::sim::Byte<1>>*)__xlx_apatb_param_alpha_transmit_line;
  port2.hasWrite = true;
  ...
  try {
    ...
    example_acc_hw_stub_wrapper(__xlx_apatb_param_w1, __xlx_apatb_param_w2, __xlx_apatb_param_alpha_transmit_line);
    port2.buffer();
