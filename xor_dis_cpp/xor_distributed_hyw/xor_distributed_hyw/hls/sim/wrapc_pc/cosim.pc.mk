...
$(ObjDir)/accelerator_controller_tb.cpp_pre.cpp.tb.o : accelerator_controller_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling accelerator_controller_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/weight_pe.cpp_pre.cpp.tb.o : weight_pe.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling weight_pe.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/error_pe.cpp_pre.cpp.tb.o : error_pe.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling error_pe.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/bias_pe.cpp_pre.cpp.tb.o : bias_pe.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling bias_pe.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/array.cpp_pre.cpp.tb.o : array.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling array.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/act_pe.cpp_pre.cpp.tb.o : act_pe.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling act_pe.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/accelerator_controller.cpp_pre.cpp.tb.o : accelerator_controller.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling accelerator_controller.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
