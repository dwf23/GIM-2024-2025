...
if {[file isfile example_acc.autotvin.dat]} {
	file delete -force example_acc.autotvin.dat
}

if {[file isfile example_acc.autotvout.dat]} {
	file delete -force example_acc.autotvout.dat
}
