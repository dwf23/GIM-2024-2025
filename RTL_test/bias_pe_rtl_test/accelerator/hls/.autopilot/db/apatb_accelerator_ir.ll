; ModuleID = 'C:/GIM-2024-2025/RTL_test/bias_pe_rtl_test/accelerator/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  call fastcc void @"onebyonecpy_hls.p0a2a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.145"([2 x [2 x i16]]* align 512 %1, [2 x [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]]* %0)
  call fastcc void @"onebyonecpy_hls.p0a2a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.145"([2 x [2 x i16]]* align 512 %3, [2 x [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]]* %2)
  call fastcc void @"onebyonecpy_hls.p0a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.121"([2 x i16]* align 512 %5, [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %4)
  call fastcc void @"onebyonecpy_hls.p0a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.121"([2 x i16]* align 512 %7, [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %6)
  ret void
}
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.117"([2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, [2 x i16]* %src, i64 2)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.117"([2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* "unpacked"="0" %dst, [2 x i16]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #1 {
entry:
  %0 = icmp eq [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.121"([2 x i16]* noalias nocapture align 512 "unpacked"="0.0" %dst, [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* noalias readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
  %0 = icmp eq [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.124"([2 x i16]* %dst, [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 2)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.124"([2 x i16]* nocapture "unpacked"="0.0" %dst, [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #1 {
entry:
  %0 = icmp eq [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.138"([2 x [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]]* nonnull %dst, [2 x [2 x i16]]* nonnull %src, i64 2)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.138"([2 x [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]]* %dst, [2 x [2 x i16]]* readonly %src, i64 %num) local_unnamed_addr #1 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @"arraycpy_hls.p0a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.141"([2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %dst.addr, [2 x i16]* %3, i64 2)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.141"([2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %dst, [2 x i16]* readonly %src, i64 %num) local_unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a2a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.145"([2 x [2 x i16]]* noalias align 512 %dst, [2 x [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]]* noalias readonly %src) unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.148"([2 x [2 x i16]]* nonnull %dst, [2 x [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]]* nonnull %src, i64 2)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.148"([2 x [2 x i16]]* %dst, [2 x [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]]* readonly %src, i64 %num) local_unnamed_addr #1 {
entry:
  %0 = icmp eq [2 x [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]]* %src, null
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %src.addr = getelementptr [2 x [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]], [2 x [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]]* %src, i64 0, i64 %for.loop.idx2
  call void @"arraycpy_hls.p0a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.151"([2 x i16]* %3, [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %src.addr, i64 2)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.151"([2 x i16]* %dst, [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* readonly %src, i64 %num) local_unnamed_addr #1 {
entry:
  %0 = icmp eq [2 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %src, null
