...
define i32 @apatb_example_acc_ir(i32 %w1, i32 %w2) local_unnamed_addr #0 {
entry:
  call fastcc void @copy_in()
  %0 = call i32 @apatb_example_acc_hw(i32 %w1, i32 %w2)
  call void @copy_back()
  ret i32 %0
}
...
declare i32 @apatb_example_acc_hw(i32, i32)
...
define i32 @example_acc_hw_stub_wrapper(i32, i32) #3 {
entry:
  call void @copy_out()
  %2 = call i32 @example_acc_hw_stub(i32 %0, i32 %1)
  call void @copy_in()
  ret i32 %2
}

declare i32 @example_acc_hw_stub(i32, i32)
