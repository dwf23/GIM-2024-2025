...
HLS_SOURCES = ../../../../../accelerator_controller_tb.cpp ../../../../../weight_pe.cpp ../../../../../send_data.cpp ../../../../../receive_data.cpp ../../../../../error_pe.cpp ../../../../../bias_pe.cpp ../../../../../array.cpp ../../../../../act_pe.cpp ../../../../../accelerator_controller.cpp
...
$(ObjDir)/accelerator_controller_tb.o: ../../../../../accelerator_controller_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../accelerator_controller_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -DHW_COSIM -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/accelerator_controller_tb.d
...
$(ObjDir)/accelerator_controller.o: ../../../../../accelerator_controller.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../accelerator_controller.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/accelerator_controller.d
