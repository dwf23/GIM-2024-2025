...
if {[file isfile spi_master_logic.autotvin.dat]} {
	file delete -force spi_master_logic.autotvin.dat
}

if {[file isfile spi_master_logic.autotvout.dat]} {
	file delete -force spi_master_logic.autotvout.dat
}
