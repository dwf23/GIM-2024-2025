...
HLS_SOURCES = ../../../../../spi_master_tb.cpp ../../../../../spi_master.cpp
...
$(ObjDir)/spi_master_tb.o: ../../../../../spi_master_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../spi_master_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -DHW_COSIM -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/spi_master_tb.d

$(ObjDir)/spi_master.o: ../../../../../spi_master.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../spi_master.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/spi_master.d
