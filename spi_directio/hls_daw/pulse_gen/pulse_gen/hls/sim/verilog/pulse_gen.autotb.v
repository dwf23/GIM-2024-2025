...
`define AUTOTB_DUT      pulse_gen
`define AUTOTB_DUT_INST AESL_inst_pulse_gen
`define AUTOTB_TOP      apatb_pulse_gen_top
`define AUTOTB_LAT_RESULT_FILE "pulse_gen.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "pulse_gen.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_pulse_gen_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_start_r 1
`define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.pulse_gen.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.pulse_gen.autotvout_ap_return.dat"
module `AUTOTB_TOP;
