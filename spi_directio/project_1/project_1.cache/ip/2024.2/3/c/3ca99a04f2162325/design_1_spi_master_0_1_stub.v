...
// Date        : Sun Feb  9 20:40:00 2025
// Host        : Lindsey_laptop running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_spi_master_0_1_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_spi_master_0_1,spi_master,{}" *) (* CORE_GENERATION_INFO = "design_1_spi_master_0_1,spi_master,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=spi_master,x_ipVersion=1.0,x_ipCoreRevision=2113943332,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "spi_master,Vivado 2024.2" *) (* hls_module = "yes" *) 
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(miso_ap_vld, data_out_ap_vld, data_in_ap_vld, 
  ap_clk, ap_rst, ap_done, ap_idle, ap_ready, ap_start, sclk, cs, mosi, miso, data_out, data_in)
/* synthesis syn_black_box black_box_pad_pin="miso_ap_vld,data_out_ap_vld,data_in_ap_vld,ap_rst,ap_done,ap_idle,ap_ready,ap_start,sclk[0:0],cs[0:0],mosi[0:0],miso[0:0],data_out[31:0],data_in[31:0]" */
