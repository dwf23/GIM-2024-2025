...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.accelerator.autotvin_w1.dat"
         "c.accelerator.autotvin_w2.dat"
         "c.accelerator.autotvin_bias_1.dat"
         "c.accelerator.autotvin_bias_2.dat"
         "c.accelerator.autotvin_training.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.accelerator.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
