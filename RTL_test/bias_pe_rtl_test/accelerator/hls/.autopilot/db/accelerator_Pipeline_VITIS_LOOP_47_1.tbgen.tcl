...
set C_modelArgList {
	...
	{ bias_2_local_1_out int 16 regular {pointer 1}  }
	{ bias_1_local_1_out int 16 regular {pointer 1}  }
	...
	{ bias_2_local_out int 16 regular {pointer 1}  }
	{ bias_1_local_out int 16 regular {pointer 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "w1", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bias_2_local_1_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bias_1_local_1_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "bias_2_local_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bias_1_local_out", "interface" : "wire", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ bias_2_local_1_out sc_out sc_lv 16 signal 8 } 
	{ bias_2_local_1_out_ap_vld sc_out sc_logic 1 outvld 8 } 
	{ bias_1_local_1_out sc_out sc_lv 16 signal 9 } 
	{ bias_1_local_1_out_ap_vld sc_out sc_logic 1 outvld 9 } 
	{ w2_local_1_out sc_out sc_lv 16 signal 10 } 
	{ w2_local_1_out_ap_vld sc_out sc_logic 1 outvld 10 } 
	{ w2_local_out sc_out sc_lv 16 signal 11 } 
	{ w2_local_out_ap_vld sc_out sc_logic 1 outvld 11 } 
	{ w1_local_1_out sc_out sc_lv 16 signal 12 } 
	{ w1_local_1_out_ap_vld sc_out sc_logic 1 outvld 12 } 
	{ w1_local_out sc_out sc_lv 16 signal 13 } 
	{ w1_local_out_ap_vld sc_out sc_logic 1 outvld 13 } 
	{ bias_2_local_out sc_out sc_lv 16 signal 14 } 
	{ bias_2_local_out_ap_vld sc_out sc_logic 1 outvld 14 } 
	{ bias_1_local_out sc_out sc_lv 16 signal 15 } 
	{ bias_1_local_out_ap_vld sc_out sc_logic 1 outvld 15 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bias_2_local_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "bias_2_local_1_out", "role": "default" }} , 
 	{ "name": "bias_2_local_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bias_2_local_1_out", "role": "ap_vld" }} , 
 	{ "name": "bias_1_local_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "bias_1_local_1_out", "role": "default" }} , 
 	{ "name": "bias_1_local_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bias_1_local_1_out", "role": "ap_vld" }} , 
 	...
 	{ "name": "bias_2_local_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "bias_2_local_out", "role": "default" }} , 
 	{ "name": "bias_2_local_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bias_2_local_out", "role": "ap_vld" }} , 
 	{ "name": "bias_1_local_out", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "bias_1_local_out", "role": "default" }} , 
 	{ "name": "bias_1_local_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bias_1_local_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	bias_2_local_1_out { ap_vld {  { bias_2_local_1_out out_data 1 16 }  { bias_2_local_1_out_ap_vld out_vld 1 1 } } }
	bias_1_local_1_out { ap_vld {  { bias_1_local_1_out out_data 1 16 }  { bias_1_local_1_out_ap_vld out_vld 1 1 } } }
	...
	bias_2_local_out { ap_vld {  { bias_2_local_out out_data 1 16 }  { bias_2_local_out_ap_vld out_vld 1 1 } } }
	bias_1_local_out { ap_vld {  { bias_1_local_out out_data 1 16 }  { bias_1_local_out_ap_vld out_vld 1 1 } } }
}
