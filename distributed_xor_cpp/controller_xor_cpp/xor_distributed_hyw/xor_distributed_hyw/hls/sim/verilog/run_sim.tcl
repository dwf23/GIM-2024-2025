...
if {[file isfile accelerator_controller.autotvin.dat]} {
	file delete -force accelerator_controller.autotvin.dat
}

if {[file isfile accelerator_controller.autotvout.dat]} {
	file delete -force accelerator_controller.autotvout.dat
}
