...
HLS_SOURCES = ../../../../../spi_master_logic_tb.cpp ../../../../../spi_master_logic.cpp
...
$(ObjDir)/spi_master_logic_tb.o: ../../../../../spi_master_logic_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../spi_master_logic_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -DHW_COSIM -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/spi_master_logic_tb.d

$(ObjDir)/spi_master_logic.o: ../../../../../spi_master_logic.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../spi_master_logic.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/spi_master_logic.d
