# 0 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\zynqmp.dtsi" 1
# 15 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\zynqmp.dtsi"
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\include/dt-bindings/dma/xlnx-zynqmp-dpdma.h" 1
# 16 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\zynqmp.dtsi" 2
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\include/dt-bindings/gpio/gpio.h" 1
# 17 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\zynqmp.dtsi" 2
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\include/dt-bindings/interrupt-controller/arm-gic.h" 1
# 9 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\include/dt-bindings/interrupt-controller/arm-gic.h"
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\include/dt-bindings/interrupt-controller/irq.h" 1
# 10 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\include/dt-bindings/interrupt-controller/arm-gic.h" 2
# 18 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\zynqmp.dtsi" 2
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\include/dt-bindings/interrupt-controller/irq.h" 1
# 19 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\zynqmp.dtsi" 2
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\include/dt-bindings/power/xlnx-zynqmp-power.h" 1
# 20 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\zynqmp.dtsi" 2
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\include/dt-bindings/reset/xlnx-zynqmp-resets.h" 1
# 21 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\zynqmp.dtsi" 2
...
# 3 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\zynqmp-clk-ccf.dtsi" 1
# 11 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\zynqmp-clk-ccf.dtsi"
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\include/dt-bindings/clock/xlnx-zynqmp-clk.h" 1
# 12 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\zynqmp-clk-ccf.dtsi" 2
/ {
...
# 4 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
...
# 5 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\pcw.dtsi" 1
 &psu_cortexa53_0 {
  xlnx,psu-ep = <1>;
  xlnx,rable = <0>;
  ...
  cpu-frequency = <1099989014>;
  xlnx,cpu-clk-freq-hz = <1099989014>;
 ...
 &amba {
  ...
  psu_ddr_0: psu_ddr@0 {
   ...
   xlnx,ddrc-act-freq-hz = <533328002>;
 ...
 &zynqmp_dpsub {
  xlnx,max-lanes = <2>;
  phys = <&psgtr 1 6 0 1>, <&psgtr 0 6 1 1>;
  xlnx,rable = <0>;
  status = "okay";
 ...
 &mc {
  ...
  xlnx,ddrc-max-operating-temparature = <1>;
  status = "okay";
  xlnx,ddrc-address-mirroring = <0>;
  xlnx,ddrc-clk-freq-hz = <266664000>;
  xlnx,qos-enable = <0>;
 ...
 &sdhci0 {
  ...
  xlnx,has-cd = <0>;
  xlnx,slot-type = <1>;
  xlnx,clk-50-sdr-otap-dly = <0x6>;
  xlnx,clk-50-ddr-itap-dly = <0x12>;
  xlnx,has-power = <0>;
  status = "okay";
 ...
 &cpu_opp_table {
  ...
  /delete-node/ opp00;
  opp-1099989014 {
   opp-hz = /bits/ 64 <1099989014>;
   clock-latency-ns = <500000>;
   opp-microvolt = <1000000>;
  };
  opp-549994507 {
   opp-hz = /bits/ 64 <549994507>;
   clock-latency-ns = <500000>;
   opp-microvolt = <1000000>;
  };
  opp-366663004 {
   opp-hz = /bits/ 64 <366663004>;
   clock-latency-ns = <500000>;
   opp-microvolt = <1000000>;
  };
  opp-274997253 {
   opp-hz = /bits/ 64 <274997253>;
   clock-latency-ns = <500000>;
   opp-microvolt = <1000000>;
  };
 };
...
# 6 "C:\\testing_comm\\spi_directio\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "osdzu3_ref";
 compatible = "xlnx,osdzu3_ref";
 device_id = "xczu3eg";
 slrcount = <1>;
 family = "ZynqMP";
