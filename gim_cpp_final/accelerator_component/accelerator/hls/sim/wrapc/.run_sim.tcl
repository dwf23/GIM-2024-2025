...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "accelerator.autotvin.dat"
	set constFileTvOut       "accelerator.autotvout.dat"
	set constFileHdlTvIn     "accelerator.autohdltvin.dat"
	set constFileHdlTvOut    "accelerator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
