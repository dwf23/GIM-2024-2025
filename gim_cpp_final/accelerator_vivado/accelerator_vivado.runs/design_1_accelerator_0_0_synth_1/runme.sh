...
HD_PWD='C:/ELEC522/GIM/GIM-2024-2025/gim_cpp_final/accelerator_vivado/accelerator_vivado.runs/design_1_accelerator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_accelerator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_accelerator_0_0.tcl
