#include "definitions.h"
 ...
 void example_acc(packet_line& out_stream, bool &wrote_flag, volatile bool &loop, packet_line& in_stream, bool &received_flag, int &received_val_1, int &received_val_2, int &interval, bool &initialized_1, bool &initialized_2) {
    /*
    ...
    */
    ...
    while(!initialized_1){
        out_stream.write_nb(initialization_packet);
        if(in_stream.read_nb(in_val)){
