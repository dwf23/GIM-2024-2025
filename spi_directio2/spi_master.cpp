...
void spi_master(hls::ap_none<bool> &sclk, hls::ap_none<bool> &cs,
                hls::ap_none<bool> &mosi, hls::ap_vld<bool> &miso,
                hls::ap_vld<int> &data_out, hls::ap_vld<int> &data_in,
                volatile bool &flag)
...
// #pragma HLS PIPELINE II = 2
  ...
  while (flag) {
    ...
    if (data_out.valid() && !transfer_active) {
      ...
      std::cout << "Chip Select Activated" << endl;
    }
...
// #pragma HLS UNROLL
        ...
        std::cout << "Writing bit" << ((send_data >> (BITS - 1 - i)) & 1)
                  << std::endl;
